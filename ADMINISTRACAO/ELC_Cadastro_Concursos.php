...
<div align="center">
  ...
  <input type="button" value="Solicitações Pendentes" onClick="javascript: location.href='ELC_Solicitacoes_Concursos.php';" />
</div>
<?php } ?>
...
<table width="85%" cellspacing="0" cellpadding="0" align="center">
    <tr>
            <td align="center">
                    ...
                    eleições que estão disponíveis para
                    edição.<br />
                    <? if ($GerenteSistema) echo "Para incluir novos concursos, clique no botão abaixo."; ?>
                    </font>
            </td>
    </tr>
    <?php
...
<div id="DivEdicaoConcurso" class="Layer1" style="width:600px; height: 300px; display: none;">
    ...
    <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" style="font-size: 10pt;">
        ...
        <tr class="Linha1">
            <td colspan="3">Modalidade da Eleição:</td>
		</tr>
        <tr class="Linha2">
            <td colspan="3"> &nbsp;
        ...
        <tr class="Linha2">
            <td colspan="3"> &nbsp;
                ...
                <label><input type="radio" name="IndContagem" id="IndContagemN" value="N" /> Não</label>
			</td>
		</tr>
        <tr class="Linha1">
        ...
        <tr class="Linha2">
            <td colspan="3"> &nbsp;
                <label><input type="radio" name="Modalidade" id="ModalidadeE" value="E" /> Eleição</label>
...
<div id="DivEdicaoEleicao" class="Layer1" style="width:600px; height: 250px; display: none;">
  <form name="FormEleicao" id="FormEleicao">
    ...
    <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" style="font-size: 10pt;">
        ...
        <tr class="Linha1">
            <td colspan="3">Descrição da Eleição:</td>
        </tr>
        <tr class="Linha2">
...
<div id="DivConsistencia" class="Layer2" style="width:550px; height: 300px; display: none;">
  <br />
	<table width="85%" border="0" cellspacing="0" cellpadding="0" align="center" style="font-size: 10pt;">
		...
		<tr class="Linha1">
			<td width="50%"> &nbsp; Número de votos logados: </td>
			<td style="text-align: center; font-weight: bold;"> <span id="Consistencia1"></span> </td>
		</tr>
		<tr class="Linha2">
			<td width="50%"> &nbsp; Número de votos computados: </td>
		...
		<tr class="Linha1">
			<td colspan="2" style="padding: 5px; text-align: justify;">
				<b>Número de votos logados</b>: Verifica se o número de votos
					 registrados no Log de Operação é igual ao número
					 de eleitores que já votaram.
			</td>
		</tr>
		<tr class="Linha2">
			<td colspan="2" style="padding: 5px; text-align: justify;">
				<b>Número de votos computados</b>: Verifica se a soma de todos os votos
					 scontados para todas as chapas/opções, incluindo brancos e nulos, dividida pelo número
					 de possibilidades de voto, é igual ao número de eleitores que
					 já votaram.
			</td>
		</tr>
	</table>
