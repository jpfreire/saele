...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr bgcolor="white">
    <td align="center" colspan="2">
        <font size="3" face="verdana"><b>Solicitação de <?=$Solicitacao->retornaString(STR_CONCURSOELEITORAL)?></b></font>
      <hr />
    </td>
  </tr>
  <tr bgcolor="white">
    <td colspan="2">
      <font size="2" face="verdana">&nbsp; <b>Data da Solicitação:</b>
  ...
  <tr bgcolor="#f5f5f5">
    <td colspan="2">
      <font size="2" face="verdana">&nbsp; Período:</font>
    </td>
  </tr>
  <tr bgcolor="#f5f5f5">
    <td width="20%">
      <font size="2" face="verdana">&nbsp;&nbsp;&nbsp; Início:</font>
    </td>
    <td>
  ...
  <tr bgcolor="#f5f5f5">
    ...
    <td>
      <font size="2" face="verdana">
        ...
        <input type="radio" name="HabilitaContagem" value="N" <?=($HabilitaContagem == "N" ? 'checked="checked"' : '')?> /> Não
      </font>
    </td>
  </tr>
  ...
  <tr bgcolor="white">
    <td colspan="2">
      <font size="2" face="verdana">&nbsp; Observações adicionais:</font>
  ...
  $linha = ($linha == "#f5f5f5" ? "white" : "#f5f5f5");
	...
	<tr class="Linha2">
	  <td colspan="2" style="font-size: 10pt;">
		  <b>Atenção:</b> os arquivos com as listas de participantes devem estar no
             diretório ARQUIVO, com o nome <b>arq_<?=$NrSeqSolicitacaoConcurso?>_[número da <?=$Solicitacao->retornaString(STR_ELEICAO)?>].txt</b>,
