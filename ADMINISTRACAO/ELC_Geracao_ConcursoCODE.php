...
/*    $NomeArq = "";
    ...
    $Mensagem = "<p>Seu Concurso Eleitoral foi gerado com as seguintes características:</p>"
               ."<p>Eleições geradas:</p>".$StrEleicoes
               ."<p>O link para acesso é <a href=\"http://alguma.coisa.com\">http://alguma.coisa.com</a></p>"
               ."<p>O ícone para a eleição segue em anexo.</p>\r\n";
    mail($Destinatario, $Titulo, $Mensagem, $Header);
