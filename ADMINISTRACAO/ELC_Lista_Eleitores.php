...
if ($Concurso->estadoConcurso() != CONCURSO_ENCERRADO) { ?>
    <div class="Erro">
        <p><strong>Erro:</strong> Lista de votantes não disponível no momento.</p>
...
<div align="center">
    <a href="ELC_Relatorio_Eleitores.php?CodConcurso=<?=$Concurso->getChave()?>&amp;CodEleicao=<?=$Eleicao->getChave().(is_null($Urna) ? null : '&amp;CodUrna='.$Urna->getChave())?>">Relatório de Eleitores</a>
