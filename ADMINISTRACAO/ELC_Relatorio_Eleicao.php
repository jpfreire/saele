...
if($ConsultaLog->executa(true)) {
    ...
    echo "<font size='2' face='verdana'><b>Dados de eleitor já carregados em ".$ConsultaLog->campo("DataOperacao", data)."</b></font>\n";
    echo "</div><br />";
}
?>
<div align="center">
    <input type="button" value="Mostrar somente Eleitores não Autenticados" onClick="javascript: xajax_CarregaListaEleitores(true)"> &nbsp;
    <input type="button" value="Mostrar Todos os Eleitores" onClick="javascript: xajax_CarregaListaEleitores();"> <br />
    (* indica pessoa não autenticada)
</div>
