...
if (!$ConsultaComissao->executa(true) && !$DireitoMaster) {
     echo "<br><font class=\"a2\">Erro! O usuário não tem permissão para acessar esta página.</font><br><br>\n";
...
if (!$ConsultaConcurso->executa(true)) {
   echo "<br><b>Erro!</b> Esta eleição ainda está ativa, ou já acabou.<br />";
   echo "<a href=\"javascript: history.back(-1);\">Voltar</a>\n";
   echo "</body></html>";
   exit;
}
