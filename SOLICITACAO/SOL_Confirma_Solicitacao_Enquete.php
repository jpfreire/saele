...
<table width="95%" border="0" cellspacing="0" cellpadding="0">
  <tr bgcolor="white">
    <td colspan="3">
      <font size="2" face="verdana"><b>&nbsp; Nome do Enquete:</b> <?=$Campos['NomeConcurso']?></font>
    </td>
  </tr>
  <tr bgcolor="#f5f5f5">
    <td colspan="3">
      <font size="2" face="verdana"><b>&nbsp; Período:</b> De <?=$Campos['DataInicio']?> às <?=$Campos['HoraInicio']?> até <?=$Campos['DataFim']?> às <?=$Campos['HoraFim']?></font>
    </td>
  </tr> 
  <tr bgcolor="white">
    <td>
  ...
  <tr bgcolor="#f5f5f5">
    <td colspan="3">
      <font size="2" face="verdana"><b>&nbsp; Questão(ões):</b><br /> &nbsp;&nbsp;&nbsp;
			<?=implode("<br /> &nbsp;&nbsp;&nbsp; ", $Campos['Eleicao'])?></font>
    </td>
  </tr>
  <tr bgcolor="white">
    <td colspan="3">
      <font size="2" face="verdana"><b>&nbsp; Tipo de Enquete:</b>
  ...
  <tr bgcolor="#f5f5f5">
    <td colspan="3">
      <font size="2" face="verdana"><b>&nbsp; Observações adicionais:</b> <?=$Campos['Observacao']?></font>
    </td>
  </tr> 
</table>
<br />
...
<div align="center">
  ...
  <input type="button" value="Voltar" onclick="javascript: document.Form.action = 'SOL_Solicitacao_Enquete.php'; document.Form.submit();" /> &nbsp;
