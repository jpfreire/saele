...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <td colspan="2">
      <font size="2" face="verdana">
        &nbsp;&nbsp;&nbsp; De <input name="DataInicio" id="DataInicio" type="text" size="10" maxlength="10" value="<?=(isset($Campos['DataInicio']) ? $Campos['DataInicio'] : null)?>" readonly="readonly" />
          ...
          <b>Atenção:</b> só serão aceitas eleições com data de início a partir de <?=$VinteDias?> <br />
  ...
  <tr bgcolor="#f5f5f5">
    ...
    <tr bgcolor="white">
      <td colspan="2">
        <font size="2" face="Verdana"><b>&nbsp; Eleições do Concurso: </b></font>
      </td>
    </tr>
    <tr bgcolor="#f5f5f5">
      <td colspan="2">
    ...
    <tr bgcolor="white">
      <td colspan="2">
        <font size="2" face="Verdana"><b>&nbsp; Tipo de Eleição: </b></font>
      </td>
    </tr>
    <tr bgcolor="#f5f5f5">
      <td colspan="2">
