...
<br />
<div align="center">
  <font size="3" face="verdana"><b>Formulário para Solicitação de Enquetes</b></font>
</div>
<br />
...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr bgcolor="white">
    <td colspan="2">
      <font size="2" face="verdana"><b>&nbsp; Nome da Enquete:</b></font>
    </td>
  </tr>
  <tr bgcolor="#f5f5f5">
    <td colspan="2">
  ...
  <tr bgcolor="white">
    <td colspan="2">
      <font size="2" face="verdana"><b>&nbsp; Período:</b></font>
    </td>
  </tr>
  <tr bgcolor="#f5f5f5">
    <td colspan="2">
      <font size="2" face="verdana">
        &nbsp;&nbsp;&nbsp; De <input name="DataInicio" id="DataInicio" type="text" size="10" maxlength="10" value="<?=(isset($Campos['DataInicio']) ? $Campos['DataInicio'] : null)?>" readonly="readonly" />
          ...
          às <input name="HoraInicio" id="HoraInicio" type="text" size="8" maxlength="5" value="<?=(isset($Campos['HoraInicio']) ? $Campos['HoraInicio'] : null)?>" />
          <b>Atenção:</b> só serão aceitas enquetes com data de início a partir de <?=$VinteDias?> <br />
        &nbsp;&nbsp;&nbsp; Até <input name="DataFim" id="DataFim" type="text" size="10" maxlength="10" value="<?=(isset($Campos['DataFim']) ? $Campos['DataFim'] : null)?>" readonly="readonly" />
          <input type="button" value=" ... " onclick="javascript: popUpCalendar(this, document.getElementById('DataFim'),'dd/mm/yyyy');" />
          às <input name="HoraFim" id="HoraFim" type="text" size="8" maxlength="5" value="<?=(isset($Campos['HoraFim']) ? $Campos['HoraFim'] : null)?>" /> </font>
    </td>
  </tr>
  <tr bgcolor="white">
    <td colspan="2">
  ...
  <tr bgcolor="#f5f5f5">
    ...
    <tr bgcolor="white">
      <td colspan="2">
        <font size="2" face="Verdana"><b>&nbsp; Questões da Enquete: </b></font>
      </td>
    </tr>
    <tr bgcolor="#f5f5f5">
      <td colspan="2">
    ...
    <tr bgcolor="white">
      <td colspan="2">
        <font size="2" face="Verdana"><b>&nbsp; Tipo de Enquete: </b></font>
      </td>
    </tr>
    <tr bgcolor="#f5f5f5">
      <td colspan="2">
    ...
    <tr bgcolor="white">
      <td colspan="2">
        <font size="2" face="Verdana"><b>&nbsp; Observações adicionais que julgar necessárias: </b></font>
      </td>
    </tr>
    <tr bgcolor="#f5f5f5">
      <td colspan="2">
...
function ValidaDataInicial() {
  ...
  if( ( (DataInicio - DataAtual) / (1000 * 60 * 60 * 24) ) < 20) {
    alert('A enquete só será aceita se realizada vinte dias após a data de hoje.');
    return false;
  }
  return true;
}
...
atributos('EleicoesConcurso', 'Questões da Enquete', texto, true);
