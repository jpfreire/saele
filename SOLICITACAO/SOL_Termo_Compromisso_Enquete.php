...
<div class="TermoParagrafo">
  A partir desta solicitação, os responsáveis (gerentes)
  serão responsáveis pela definição do público-alvo,
  dos locais de votação e do cronograma eleitoral.
</div>
<div class="TermoParagrafo">
  Para configuração da Eleição, o responsável pelo
	sistema entrará em contato para agendar uma reunião presencial, onde
	serão estabelecidas as especificações para o arquivo com a
	lista de participantes do Concurso e as imagens das opções.
</div>
