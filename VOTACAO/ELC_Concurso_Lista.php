...
<div class="a3">Não há Concursos Eleitorais / Enquetes disponíveis neste momento!</div>
<br /><br />
<?php
}
else {
  do { ?>
    <table border="1" cellspacing="0" cellpadding="0" width="85%" class="tabela" bgcolor="white" align="center">
      <tr>
        <td align="left">
          &nbsp;<?=$ConsultaConcursos->campo("Descricao")?> (de <?=$ConsultaConcursos->campo("DataHoraInicio", data)?> até <?=$ConsultaConcursos->campo("DataHoraFim", data)?>)
        </td>
   ...
   <tr>
     <td align="center">
       <font size="2" face="verdana">
         <a href="../ELC_Logout.php">Clique aqui para sair da Eleição</a>
       </font>
     </td>
   </tr>
</table>
